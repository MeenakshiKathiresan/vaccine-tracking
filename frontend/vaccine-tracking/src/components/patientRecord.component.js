        ...
        <div className="card phase-box ">
            <div >
                <div className="p-3 border-bottom d-flex justify-content-between">
                    ...
                    <div className="tag" style={{ backgroundColor: color }}> {dummyRecord.Status}</div>
                ...
                {isOpen && (
                    ...
                    <div className="p-4">
                        ...
                        <div className="sub-heading-text d-flex justify-content-between">
                            <div>Blood Pressure: {dummyRecord.vitals["Blood pressure"]} <br /> </div>
                            <div> Heart rate: {dummyRecord.vitals["Heart rate"]} <br /> </div>
                            <div>Temperature: {dummyRecord.vitals["Temperature"]} <br /></div>
                            <div>Respiratory rate: {dummyRecord.vitals["Respiratory rate"]} <br /></div>

                        </div> <br/>
                        <div className="heading-text py-2"> Medication: </div>
                        <div className="sub-heading-text">{dummyRecord.Medication} </div><br />
                        <div className="heading-text py-2">Observation:</div>
                        <div className="sub-heading-text"> {dummyRecord.Observation}</div> <br />
